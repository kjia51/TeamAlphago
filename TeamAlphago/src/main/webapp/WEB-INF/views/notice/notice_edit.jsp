                        ...
                        <table class="table table-bordered table-form">
                            ...
                            <tbody>
                                ...
                                <tr>
                                	<th scope="row">내용</th>
                                   <td>
                                   		<textarea id="editor" name="n_content" style="width:100%; height:450px; border:1px solid #ccc;">
                                   			${noticeVO.n_content }
                                   		</textarea>
                                   </td>
                                </tr>
...
$(document).ready(function() {
	var n_title = localStorage.getItem('n_title');
	var n_content = localStorage.getItem('n_content');

	document.querySelector('input[name="n_title"]').value = n_title;
	$('textarea[name="n_content"]').val(n_content);
