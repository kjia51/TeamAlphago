...
.signup_email{
	width:210px; height:16px; padding:10px; border:1px solid #ccc; font-size:13px;line-height: 0
}
td{
	height: 38px;
}
                        ...
                        <table class="table table-bordered table-form">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="signup_email" id="signup_email" value="${email }" disabled />
